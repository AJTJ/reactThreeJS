      ...
      <form className={`controlsForm ${this.props.controlsHidden ? 'controlsHidden' : ''}`} action="">
        ...
        <div className="sectionWrapper">
          ...
          <div className="bulbSpeed__wrapper" >
            ...
            <div className="bulbControl__wrapper">
              ...
              <div>
                <NumericInput onChange={this.props.topBulbLumChange} className="numberInput" step={50} max={2000} min={1} value={this.props.topBulbLum} />
              </div>
            </div>
            ...
            <div className="bulbControl__wrapper">
              ...
              <div>
                <NumericInput onChange={this.props.middleBulbLumChange} className="numberInput" step={50} max={2000} min={1} value={this.props.middleBulbLum} />
              </div>
            </div>
            ...
            <div className="bulbControl__wrapper">
              ...
              <div>
                <NumericInput onChange={this.props.bottomBulbLumChange} className="numberInput" step={50} max={2000} min={1} value={this.props.bottomBulbLum} />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="nameSocials" >
          ...
          <span className="socials">
            <a href="https://www.aaronjanke.com" target="_blank"><i className="fas fa-mouse-pointer"></i></a>
